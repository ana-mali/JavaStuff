...
public class RTNumericView extends JPanel {
	...
	public void propertyChange(final PropertyChangeEvent evt) {
	    RTNumericView.this.base.setText(
		    decimalFormat.format(RTNumericView.this.model.getBase()));
	    RTNumericView.this.hypo.setText(RTNumericView.decimalFormat
		    .format(RTNumericView.this.model.getHypotenuse()));
	}
    }
	...
	@Override
	public void propertyChange(final PropertyChangeEvent evt) {
	    RTNumericView.this.height.setText(
		    decimalFormat.format(RTNumericView.this.model.getHeight()));
	    RTNumericView.this.hypo.setText(RTNumericView.decimalFormat
		    .format(RTNumericView.this.model.getHypotenuse()));
	}
    }
	...
	this.hypo.setText(
		RTNumericView.decimalFormat.format(this.model.getHypotenuse()));
    }
	...
	this.model.addPropertyChangeListener(RTModel.Type.BASE,
		new BaseListener());
	this.model.addPropertyChangeListener(RTModel.Type.HEIGHT,
		new HeightListener());
    }
